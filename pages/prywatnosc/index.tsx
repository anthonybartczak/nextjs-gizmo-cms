          ...
          <div className="flex flex-col max-w-2xl mx-4 xl:mx-auto mt-5">
            <article className={styles.content}>
              ...
              <p>
                ...
                <a href="https://gizmo.com.pl/prywatnosc">Regulaminu Serwisu</a>
              ...
              <ul>
                <li>
                  <p>
                    <strong>Serwis</strong> - serwis internetowy gizmo.com.pl
                    działający pod adresem https://gizmo.com.pl
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    ...
                    Administrator) jest firma Gizmo Szymon Wiśniewski,
                    prowadząca działalność pod adresem: ul. Mikołaja Gogola
                    1/145, 92-513 Łódź, o nadanym numerze identyfikacji
                    podatkowej (NIP): 7282690490, świadcząca usługi drogą
                ...
                <li>
                  <p>
                    <strong>Urządzenie</strong> - elektroniczne urządzenie wraz
                    z oprogramowaniem, za pośrednictwem którego Użytkownik
                ...
                <li>
                  <p>
                    ...
                    numer identyfikacyjny, dane o lokalizacji, identyfikator
                ...
                <li>
                  <p>
                    ...
                    operacji wykonywanych na danych osobowych lub zestawach
                ...
                <li>
                  <p>
                    ...
                    polega na wykorzystaniu danych osobowych do oceny niektórych
                ...
                <li>
                  <p>
                    ...
                    powiązanie danego rekordu z konkretnym użytkownikiem lub
                    osobą fizyczną.
                  </p>
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Serwisie poprzez skrypty i usługi udostępnione i
              ...
              <ul>
                <li>
                  <p>
                    ...
                    witryn internetowych, które odwiedzał Użytkownik, w tym
                    danych osobowych ani informacji poufnych. Przeniesienie na
                ...
                <li>
                  <p>
                    ...
                    Administrator do współpracy dobiera znanych, dużych
                    partnerów o globalnym zaufaniu społecznym. Nie posiada on
                    jednak pełnej kontroli nad zawartością plików Cookie
                    pochodzących od zewnętrznych partnerów. Za bezpieczeństwo
                    plików Cookie, ich zawartość oraz zgodne z licencją
                    wykorzystanie przez zainstalowane w serwisie Skrypty,
                    pochodzących z Serwisów zewnętrznych, Administrator nie
                ...
                <li>
                  <p>
                    ...
                    celu zapewnienia bezpieczeństwa danych umieszczanych w
                    ...
                    odpowiedzialności za przechwycenie tych danych, podszycie
                    się pod sesję Użytkownika lub ich usunięcie, na skutek
                    świadomej lub nieświadomej działalność Użytkownika, wirusów,
                    koni trojańskich i innego oprogramowania szpiegującego,
                    którymi może jest lub było zainfekowane Urządzenie
                    Użytkownika. Użytkownicy w celu zabezpieczenia się przed
                    tymi zagrożeniami powinni stosować się do zasad
                    zwiększających ich{" "}
                    <a
                      rel="external"
                ...
                <li>
                  <p>
                    ...
                    Użytkowników były bezpieczne, dostęp do nich był ograniczony
                    i realizowany zgodnie z ich przeznaczeniem i celami
                    przetwarzania. Administrator zapewnia także, że dokonuje
                    wszelkich starań w celu zabezpieczenia posiadanych danych
                    przed ich utratą, poprzez stosowanie odpowiednich
              ...
              <ul id="cele">
                ...
                <li>
                  Prowadzenie statystyk (użytkowników, ilości odwiedzin,
                  rodzajów urządzeń, łącze itp.)
                </li>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      Serwisie w serwisach społecznościowych lub innych
                      witrynach.
                    </li>
                  </ul>
                </li>
              ...
              <p>
                ...
                <strong>
                  <a
                    rel="nofollow external"
                    href="https://thecamels.org/regulamin/polityka-prywatnosci-i-plikow-cookies/"
                  >
                    THECAMELS SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ
                  </a>
                </strong>
                ...
                możliwość dostępu do danych wskutek prac serwisowych
              ...
              <ul>
                <li>
                  ...
                  Użytkownika (np. wprowadzenie komentarza lub wpisu), co
                  sprawi, że dane będą dostępne dla każdej osoby odwiedzającej
                  serwis.
                </li>
                <li>
              ...
              <ul>
                ...
                <li>
                  Dane anonimiwe (bez danych osobowych) nie będą wykorzystywane
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    zastrzega sobie prawo wstrzymania realizacji żądania
                    usunięcia danych w celu ochrony prawnie uzasadnionego
                    interesu Administratora (np. w gdy Użytkownik dopuścił się
                    naruszenia Regulaminu czy dane zostały pozyskane wskutek
                    prowadzonej korespondencji).
                    <br />W przypadku usługi Newsletter, Użytkownik ma możliwość
                    samodzielnego usunięcia swoich danych osobowych korzystając
                    z odnośnika umieszczonego w każdej przesyłanej wiadomości
                    e-mail.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    ...
                    danych osobowych dotyczących Użytkownika w
                    ustrukturyzowanym, powszechnie używanym formacie nadającym
                    się do odczytu maszynowego, realizowane na żądanie złożone
                    do Administratora
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>
                  <p>
                    <strong>Adres pocztowy</strong> - Gizmo Szymon Wiśniewski,
                    ul. Mikołaja Gogola 1/145, 92-513 Łódź
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Połączenie telefoniczne</strong> - +48 664 720 021
                  </p>
                </li>
                <li>
                  <p>
                    <strong>Formularz kontaktowy</strong> - dostępny pod
                    adresem: /kontakt
                  </p>
                </li>
              </ul>
              ...
              <ul>
                <li>
                  <p>
                    ...
                    Użytkownika może spowodować nieprawidłowe działanie
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    terminie do 7 dni od zmiany zapisów. Dalsze korzystanie z
                    usług oznacza zapoznanie się i akceptację wprowadzonych
                    zmian Polityki Prywatności. W przypadku w którym Użytkownik
                    nie będzie się zgadzał z wprowadzonymi zmianami, ma
                    obowiązek usunąć swoje konto z Serwisu lub wypisać się z
                    usługi Newsletter.
                  </p>
                </li>
                <li>
                  <p>
                    Wprowadzone zmiany w Polityce Prywatności będą publikowane
                    na tej podstronie Serwisu.
                  </p>
                </li>
                <li>
                  <p>
